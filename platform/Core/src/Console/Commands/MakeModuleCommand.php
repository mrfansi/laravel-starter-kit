...
class MakeModuleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:module {name : The name of the module} {--force : Force the operation to run when the module already exists} {--all : Generate a module with all components} {--controller : Generate a controller for the module} {--model : Generate a model for the module} {--migration : Generate a migration for the module} {--api : Generate an API controller for the module} {--view : Generate views for the module}';
